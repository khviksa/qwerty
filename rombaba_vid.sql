...
CREATE TABLE `vid` (
  ...
  `vidtovara` varchar(30) DEFAULT NULL,
  `postavshik` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`ID`)
...
INSERT INTO `vid` VALUES (1,'Торт','Грибинчик В.А.'),(2,'Пирожное','Кучелаева В.С.'),(3,'Печенье','Бублик У.О.'),(4,'Выпечка','Кремов П.А.');
